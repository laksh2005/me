        ...
        {blogsData.length === 0 ? (
          <div className="flex items-center justify-center min-h-[400px] element-enter-3">
            <div className="text-center">
              <p className="text-zinc-500 text-lg font-serif-title mb-2">New Blogs Coming Soon</p>
              <p className="text-zinc-600 text-sm">I'm working on sharing my thoughts and insights. Stay tuned!</p>
            </div>
          </div>
        ) : (
