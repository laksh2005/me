...
const inputClassName = "w-full bg-transparent outline-none";
...
const SmoothInput = ({
  ...
  // The upstream component drove these from a `useDialKit` live tuning panel,
  // which is demo scaffolding: it renders a floating control UI and, worse,
  // its own defaults win over the `placeholder` and `type` props passed in.
  // Fixed values here, with the real props honoured.
  const params = {
    inputType: type,
